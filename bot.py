...
from handlers import profile_page, story_page, contact_page, menu_page, categorie_page, drink_page, update_options, \
    preadded_page, count_drink, busket_page, red_offer_page,admin_page,red_stop_page

logging.basicConfig(level=logging.INFO)


async def main():
    bot = Bot(token='6042184403:AAGzDK5eMNnVXx8SB-PYU6PR8zGSXFRq_xM', parse_mode='HTML')
    dp = Dispatcher()
